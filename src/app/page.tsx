    ...
    <div className="flex flex-col w-full">
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center pt-20 overflow-hidden">
        ...
        <div className="absolute inset-0 z-0 bg-[#0a0f1e]">
          ...
          {[
            { top: "15%", left: "12%", size: 4 }, { top: "72%", left: "20%", size: 3 },
            { top: "40%", left: "45%", size: 5 }, { top: "85%", left: "60%", size: 3 },
            { top: "25%", left: "78%", size: 4 }, { top: "60%", left: "88%", size: 3 },
          ].map((dot, i) => (
            <div key={i} className="absolute rounded-full bg-accent-gold/40 animate-pulse"
              style={{ top: dot.top, left: dot.left, width: dot.size, height: dot.size, animationDelay: `${i * 0.8}s`, animationDuration: "4s" }} />
          ))}
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          <div className="max-w-3xl">
            <div className="inline-flex items-center space-x-2 bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full mb-6 border border-white/20">
              ...
              <span className="text-white text-xs font-semibold tracking-wider uppercase">Legal Information Portal</span>
            </div>
            ...
            <p className="text-lg md:text-xl text-gray-200 mb-10 max-w-2xl font-light leading-relaxed">
              Providing comprehensive legal consultancy and professional information across diverse practice areas in Nepal. Committed to integrity and the rule of law.
            </p>
      ...
      <section className="bg-white dark:bg-dark-neutral border-b border-gray-100 dark:border-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 py-12">
            {[
              { icon: Landmark, title: "Legal Representation", desc: "Core consultancy across legal sectors." },
              { icon: ShieldCheck, title: "Professional Ethics", desc: "Committed to the legal code of conduct." },
              { icon: Scale, title: "Client Focused", desc: "Providing objective legal information." },
              { icon: Award, title: "Established Profile", desc: "Documented legal experience in Nepal." }
            ].map((feature, i) => (
